            ...
            <tr>
                ...
                <td nowrap>
                    <div class="btn-group" role="group" aria-label="..." style="width:60px;">
                        <a class="btn btn-default btn-xs" href="<?php echo erLhcoreClassDesign::baseurl('fbmessenger/editnotification')?>/<?php echo $item->id?>" ><i class="material-icons mr-0">&#xE254;</i></a>
...
<a href="<?php echo erLhcoreClassDesign::baseurl('fbmessenger/newnotification')?>" class="btn btn-default"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('module/fbmessenger','New notification');?></a>
