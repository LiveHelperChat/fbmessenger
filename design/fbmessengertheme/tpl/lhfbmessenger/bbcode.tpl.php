        ...
        <tr>
            ...
            <td nowrap>
                <div class="btn-group" role="group" aria-label="..." style="width:60px;">
                    <a class="btn btn-secondary btn-xs" href="<?php echo erLhcoreClassDesign::baseurl('fbmessenger/editbbcode')?>/<?php echo $item->id?>" ><i class="material-icons mr-0">edit</i></a>
                    <a class="btn btn-danger btn-xs csfr-required" onclick="return confirm('<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('kernel/messages','Are you sure?');?>')" href="<?php echo erLhcoreClassDesign::baseurl('fbmessenger/deletebbcode')?>/<?php echo $item->id?>" ><i class="material-icons mr-0">delete</i></a>
                </div>
            </td>
        </tr>
    <?php endforeach; ?>
