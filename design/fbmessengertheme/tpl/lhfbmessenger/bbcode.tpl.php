        ...
        <tr>
            ...
            <td nowrap>
                <div class="btn-group" role="group" aria-label="..." style="width:60px;">
                    ...
                    <a class="btn btn-danger btn-xs csfr-required" onclick="return confirm('<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('kernel/messages','Are you sure?');?>')" href="<?php echo erLhcoreClassDesign::baseurl('fbmessenger/deletebbcode')?>/<?php echo $item->id?>" ><i class="material-icons mr-0">&#xfa78;</i></a>
                </div>
            </td>
        </tr>
    <?php endforeach; ?>
...
<a href="<?php echo erLhcoreClassDesign::baseurl('fbmessenger/newbbcode')?>" class="btn btn-secondary"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('module/fbmessenger','Register new BBCode');?></a>